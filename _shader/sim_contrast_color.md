---
title: Simultaneous color contrast
author: Bernhard Lang
file: sim_contrast_color.frag
---
```
...
vec3 edge(vec2 pos, vec3 cl_left, vec3 cl_right) {
    ...
    return (cl_right - cl_left)
           * smoothstep(ed - 1.0/u_resolution.x,
                        ed + 1.0/u_resolution.x,
                        pos.x)
           + cl_left;
}
...
float triangle(float pulse_width, float overshoot) {
    return (1.0 + overshoot)
           * (step(0.5, fract(u_time/pulse_width))
